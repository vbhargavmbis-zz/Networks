...
b) In Phase 3 of the project, there are 4 entities: Major, Captain 1, Captain 2 and the General. The General behaves as the server to the Major and the Major behaves as the Server to the 2 Captains, which act as Clients. However, the Captains will behave as servers and the General as the client.
